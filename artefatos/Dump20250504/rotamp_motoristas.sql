...
CREATE TABLE `motoristas` (
  ...
  CONSTRAINT `motoristas_ibfk_2` FOREIGN KEY (`veiculo_id`) REFERENCES `veiculos` (`id`)
...
INSERT INTO `motoristas` VALUES (4,11,3,'2025-04-29 23:24:47'),(5,12,4,'2025-04-29 23:25:21');
