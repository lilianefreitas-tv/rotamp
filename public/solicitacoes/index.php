                ...
                <tbody>
                    <?php foreach ($solicitacoes as $solicitacao): ?>
                        <tr>
                            ...
                            <!--<td>
                            <a href="visualizar.php?id=<?php echo $solicitacao['id']; ?>" class="btn btn-sm btn-info">Ver</a>
                             Futuro: botão de editar, cancelar, etc 
                        </td>-->
                            <td>
                                <?php if ($solicitacao['status'] === 'finalizado'): ?>
